...
import com.toufikforyou.colormatching.main.domain.model.ColorBox
    ...
    repeat(count) {
        ...
        do {
            ...
            isSimilar = colors.any { color ->
                ...
                sqrt((redDiff * redDiff + greenDiff * greenDiff + blueDiff * blueDiff).toDouble()) < similarityThreshold
            }
